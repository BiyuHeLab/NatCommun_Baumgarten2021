...
[r_beta(i_sub) p_beta(i_sub)] = corr(stimf.beta', dataf.resp_beta', 'type', np_corr_type);

f = stimf.beta < 1.5;
[r_beta_low(i_sub) p_beta_low(i_sub)] = corr(stimf.beta(f)', dataf.resp_beta(f)', 'type', np_corr_type);
...
[r_conf(i_sub)  p_conf(i_sub) ] = corr(dataf.conf_beta', abs(dataf.diff_beta'),  'type', np_corr_type);
[r_conf3(i_sub) p_conf3(i_sub)] = corr(dataf.conf_beta', abs(dataf.diff_beta3)', 'type', np_corr_type);
...
for i_b = 1:5
    ...
    f = stimf.betaID == i_b;
    [r_conf_b{i_b}(i_sub)  p_conf_b{i_b}(i_sub) ] = corr(dataf.conf_beta(f)', abs(dataf.diff_beta(f))',  'type', np_corr_type);
    [r_conf3_b{i_b}(i_sub) p_conf3_b{i_b}(i_sub)] = corr(dataf.conf_beta(f)', abs(dataf.diff_beta3(f))', 'type', np_corr_type);
...
for i_r = 1:5
    ...
    [r_conf_r{i_r}(i_sub)  p_conf_r{i_r}(i_sub) ] = corr(dataf.conf_beta(f)', abs(dataf.diff_beta(f))',  'type', np_corr_type);
    [r_conf3_r{i_r}(i_sub) p_conf3_r{i_r}(i_sub)] = corr(dataf.conf_beta(f)', abs(dataf.diff_beta3(f))', 'type', np_corr_type);
...
corr_type = np_corr_type; % 'Pearson';
...
% % %     end
    ...
    [r_pmp(i_sub, i_iv) p_pmp(i_sub, i_iv)] = corr(prob_model{i_iv, i_sub}', dataf.resp_prob', 'type', np_corr_type);
