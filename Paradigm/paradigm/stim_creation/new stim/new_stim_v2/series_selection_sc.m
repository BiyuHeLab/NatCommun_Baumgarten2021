...
%         medInd1 = ind_sort(current_ind);
%         if ~any(medInd1 == [minInd1, maxInd1])
%             found_unique = 1;
%         end
%     end
...
%     while ~found_unique
%         current_ind = current_ind + 1;
%         medInd2 = ind_sort(current_ind);
%         if ~any(medInd2 == [inds1_cell{i_b}, minInd2, maxInd2])
%             found_unique = 1;
%         end
%     end
    ...
    disp(['i_b = ' num2str(i_b)])
    inds2
    inds2_cell{i_b} = inds2;
end



for i_b=1:5
    indeces(i_b,:) = [inds1_cell{i_b}, inds2_cell{i_b}];
end
