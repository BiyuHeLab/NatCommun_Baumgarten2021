function [svm_acc, models] = matsvm_nfold(group, data, nfolds, nreps, scale_data)
% svm_acc = libsvm_nfold(group, data, nfolds, nreps, scale_data)
% 
...
for i_fold = 1:nfolds
    ...
    parfor rand_rep = 1:nreps
        ...
        % train and classify
        model = matsvmtrain(group_train_i, data_train_i, scale_data);
        predicted_group = matsvmpredict(group_test, data_test, model);              
