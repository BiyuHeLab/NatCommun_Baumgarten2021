function [clusters_orig, clusters_shuffle, shuffleMaxStatPos] = cluster_test_temporal_svm_noparfor(labels, data, p_thresh, nReps, libsvm_settings)
...
for i_sub = 1:nSubs
    ...
    for i_sample = 1:nSamples
        ...
        svm_acc = libsvm_nfold_noparfor(labels_i, data_i, nfolds, nreps_svm, libsvm_options_train, libsvm_options_test, scale_data);       
...
for i_rep = 1:nReps
    ...
    for i_sub = 1:nSubs
        ...
        for i_sample = 1:nSamples
            ...
            svm_acc = libsvm_nfold_noparfor(labels_shuffled, data_i, nfolds, nreps_svm, libsvm_options_train, libsvm_options_test, scale_data);
