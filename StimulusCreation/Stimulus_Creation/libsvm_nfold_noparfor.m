function [svm_acc, models, activation_patterns] = libsvm_nfold_noparfor(group, data, nfolds, nreps, libsvm_options_train, libsvm_options_test, scale_data)
% [svm_acc, models, activation_patterns] = libsvm_nfold(group, data, nfolds, nreps, libsvm_options_train, libsvm_options_test, scale_data)
% 
% group  - label for each trials
% data   - nTrials x nAttributes matrix
